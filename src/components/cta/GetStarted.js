...
import kidlatLogo from "../../images/kidlatLogo.png";
...
const PrimaryLink = tw(Link)`bg-black text-gray-100 shadow-lg hocus:bg-yellow-600 hocus:text-gray-200`;

const SecondaryLink = tw(Link)`text-black border-black`;
...
export default ({
  text = "Serbisyong simbilis ng kidlat ang aming hatid!",
  primaryLinkText = "Apply as Rider",
  primaryLinkUrl = "/RiderApplication",
    ...
    <Container css={pushDownFooter && tw`mb-20 lg:mb-24`}>
      ...
      <PrimaryBackgroundContainer>
        <Row>
          ...
          <LinksContainer>
          {/* <img src={kidlatLogo} alt="" tw="h-auto w-40" /> */}
