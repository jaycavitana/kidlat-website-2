...
const SubmitButton = styled.button`
  ${tw`mt-5 tracking-wide font-semibold bg-primary-500 text-black w-full py-4 rounded-lg hover:bg-black hover:text-primary-500 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none`}
  .icon {
    ${tw`w-6 h-6 -ml-2`}
  }
  .text {
              ...
              <p tw="mb-6 text-sm text-gray-600">
                ...
                <div tw="flex flex-wrap -mx-3 mb-2">
                    ...
                    <div tw="w-full md:w-1/3 px-3 mb-6 md:mb-0 mt-2">
                        ...
                        <Input tw="appearance-none block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white mt-0"  type="file" name="imiepic" />
                ...
                <div tw="flex flex-wrap -mx-3 mb-2">
                    ...
                    <div tw="w-full md:w-1/3 px-3 mb-6 md:mb-0 mt-2">
                        <label tw="block  tracking-wide text-gray-700 text-sm ">
                            ...
                            <input  type="radio" value="professional"name="professiona" /> Professional
                ...
                <div tw="flex flex-wrap -mx-2 mb-6">
                    ...
                    <div tw="w-full md:w-1/2 px-3 mb-6 md:mb-0 mt-2">
                        ...
                        <input  type="radio" value="none" name="nowork"/> I don't have work
                    ...
                    <div tw="w-full md:w-1/2 px-3 mb-6 md:mb-0 mt-2">
                        ...
                        <input  type="radio" value="no" name="notbikermember"/> NO
                        <input tw="ml-3"type="radio" value="yes" name="yesbikermember" /> YES
                ...
                <div tw="flex flex-wrap -mx-2 mb-6">
                    ...
                    <div tw="w-full md:w-1/2 px-3 mb-6 md:mb-0 mt-2">
                        ...
                        <input  type="radio" value="no" name="noseperatephone" /> NO
                        <input tw="ml-3"type="radio" value="yes"  name="haveseperatephone"/> YES
                    ...
                    <div tw="w-full md:w-1/2 px-3 mb-6 md:mb-0 mt-2">
                        ...
                        <input  type="radio" value="texted" name="iftexted"/> When Kidlat texted me
                        <input tw="ml-3"type="radio" value="notsure" name="notsure" /> Not yet sure
                ...
                <div tw="flex flex-wrap -mx-3 mb-3 mt-6">
                    <div tw="w-full px-3 text-xs" >
                        <input tw="ml-3"type="checkbox" value="agree" /> In addition to the national licensing policy or the requirements of any authority, this company may conduct a background check.
                    </div>
